...
class LSTMRegressor(nn.Module):
    """LSTM regressor for lagged return features.
...
def main() -> None:
    ...
    # Default grid excludes daily rebalancing to keep turnover in a realistic range.
    ...
    model = LSTMRegressor(input_dim=input_dim, hidden=args.hidden, depth=args.depth, dropout=args.dropout).to(device)
